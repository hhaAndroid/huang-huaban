 ...
 */
public class RecyclerPeopleAdapter extends BaseRecyclerAdapter<SearchPeopleListBean.UsersBean> {
    ...
    public interface OnAdapterListener {
        void onClickUser(SearchPeopleListBean.UsersBean bean, View view);
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        //Logger.d(life);
        final SearchPeopleListBean.UsersBean bean = mList.get(position);
    ...
    private void onBindData(final ViewHolderGeneral holder, SearchPeopleListBean.UsersBean bean) {
        //检查图片信息
...
//            holder.img_image_user.setImageURI(null);
     ...
     * @return
     */
    private boolean checkInfoContext(SearchPeopleListBean.UsersBean bean) {
        return true;
    }

    private void onBindListener(ViewHolderGeneral holder, final SearchPeopleListBean.UsersBean bean) {
